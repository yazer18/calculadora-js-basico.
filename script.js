...
function calcularCuadrado() {
    // Obtener valor del input y calcular su cuadrado
...
function calcularPromedio() {
    ...
    if ([n1,n2,n3].some(x => isNaN(x))) {
        document.getElementById("resultadoPromedio").textContent = "Ingrese las tres notas correctamente.";
        return;
    }
...
function convertirMetros() {
    ...
    if (isNaN(metros)) {
        document.getElementById("resultadoConversion").textContent = "Ingrese un valor en metros válido.";
        return;
    }
...
function compararValores() {
    ...
    if (isNaN(v1) || isNaN(v2)) {
        document.getElementById("resultadoComparacion").textContent = "Ingrese ambos números correctamente.";
        return;
    }
